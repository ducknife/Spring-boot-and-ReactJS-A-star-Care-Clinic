            ...
            <div className="bg-[var(--brand-navy)]">
                <div className="mx-auto grid max-w-7xl gap-10 px-6 py-16 md:grid-cols-4">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <div className="text-2xl font-semibold">
                                ...
                                <span className="text-[var(--brand-200)]">Care</span>
                            </div>
                        </div>
                        ...
                        <a href="tel:0379330721" className="mt-6 block text-white text-lg font-semibold hover:underline">
                            037 933 0721
                        </a>
                    ...
                    <div>
                        ...
                        <div className="h-1 w-12 bg-[var(--brand-500)] rounded mt-3" />
                        ...
                        >
                            <div className="flex items-center">
                                ...
                                <button
                                    type="submit"
                                    className="
                                        -ml-px rounded-full bg-[var(--brand-600)] hover:bg-[var(--brand-700)]
